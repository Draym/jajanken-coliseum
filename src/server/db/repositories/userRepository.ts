import {User, UserDocument, ICreateUser, IUpdateUser} from '@/server/db/models/User'
...
const updateById = async (id: string | ObjectId, user: IUpdateUser): Promise<UserDocument | null> => await User.findByIdAndUpdate(id, user)
